// <copyright file="MetricSnapshotElasticsearchWriterTests.cs" company="Allan Hardy">
...
{
    public class MetricSnapshotElasticsearchWriterTests
    {
        ...
        private void AssertExpectedLineProtocolString(MetricsDataValueSource dataValueSource, string expected)
        {
            ...
            {
                using (var packer = new MetricSnapshotElasticsearchWriter(
                    sw,
                    "index",
                    ElasticsearchFormatterConstants.ElasticsearchDefaults.MetricNameFormatter,
                    ElasticsearchFormatterConstants.ElasticsearchDefaults.MetricTagValueFormatter))
                {
